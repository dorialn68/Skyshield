...
const megaMenuContent = {
  ...
  whyNow: {
    kicker: "הצורך המבצעי",
    title: "למה עכשיו",
    description: "איומים רבים, זולים ומהירים מחייבים נוכחות רציפה, גילוי מוקדם ותגובה מדויקת לפני קו המגע.",
    links: [["#system", "הצורך והמענה"], ["#experience", "ניסיון מוכח"]]
  },
  alons: {
    kicker: "נכס אווירי מתמיד",
    title: "AlonS",
    description: "מודל תלת־ממד אינטראקטיבי המציג את כלי הטיס, תחנות המערכת וסביבות התאורה ב־360°.",
    links: [["#modelFrame", "מודל 360°"], ["#architecture", "ארכיטקטורת המערכת"]]
  },
  block0: {
    kicker: "BASELINE",
    title: "Block 0",
    description: "מטוס הייחוס המוסב מבסס את קו הפתיחה לניסויי הטיסה ואת הדרך לאימות המערכות.",
    links: [["#block-0", "נתוני Block 0"], ["#experience", "מסלול הסבה מוכח"]]
  },
  block1: {
    kicker: "OBJECTIVE",
    title: "Block 1",
    description: "יעד התכן המיועד לייצור מגדיר את הביצועים, מעטפת המשימה ויכולת הצמיחה של הפלטפורמה.",
    links: [["#block-1", "יעדי Block 1"], ["#architecture", "שכבות המערכת"]]
  },
  progress: {
    kicker: "מהשקעה לטיסה",
    title: "התקדמות ומה הושקע",
    description: "רצף עבודה מדורג מהסכמות מסחריות, דרך הדגמה קרקעית, ועד סדרת טיסות ניסוי.",
    links: [["#roadmap", "אבני הדרך"], ["#investmentDetails", "עיקרי ההשקעה"]]
  },
  whyArith: {
    kicker: "שותפות אסטרטגית",
    title: "למה ארית",
    description: "יכולות חימוש, אלקטרוניקה ובקרה מתחברות לפלטפורמה אווירית שלמה עם נתיב ניסויים ויכולת צמיחה.",
    links: [["#arit", "החיבור לארית"], ["#roadmap", "נתיב ההתקדמות"]]
  }
};

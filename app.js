...
const translations = {
  en: {
    ...
    hotspotRemoteWeapon: "EO/IR kinetic gimbal",
    ...
    focusLandingGearText: "Two main legs deploy perpendicular to the low wing through wing-integrated trunnion housings. Each assembly is enclosed by a full-depth composite leg fairing flowing into a complete aerodynamic wheel spat, with the wheel, axle and fork hidden from the external view; there is no nose wheel.",
    ...
    focusRemoteWeaponText: "Reference-matched exterior demonstrator with a continuous aircraft interface, vibration-isolated suspension frame, layered multi-axis stabilization stack, articulated service carrier, twin elevation yoke, dominant side-drive housing, integrated four-aperture EO/IR face and ventilated barrel shroud. External presentation geometry only; mass properties, recoil management and airworthiness remain subject to engineering validation.",
    ...
    focusExternalInterfaceText: "Two teardrop external fuel-tank visualizations are blended directly into clean continuous underwing pylons, without exposed suspension pins or unrelated mounting blocks; internal fuel-system detail is not shown.",
  ...
  he: {
    ...
    hotspotRemoteWeapon: "צריח קינטי EO/IR",
    ...
    focusLandingGearText: "שני כני הנסע יורדים בניצב לכנף הנמוכה דרך בתי ציר המשולבים במבנה הכנף. כל מכלול מכוסה בחיפוי מרוכב מלא לזרוע ובחיפוי אווירודינמי סגור סביב הגלגל, כך שהגלגל, הציר והמזלג אינם חשופים במבט חיצוני; אין כן נסע קדמי.",
    ...
    focusRemoteWeaponText: "מדגים חיצוני מפורט התואם את מכלול הייחוס: ממשק מטוס רציף, מתלה מבודד־רעידות, מערכת ייצוב רב־צירית, שרשרת שירות מפרקית, עריסת הגבהה דו־צדדית, בית הנעה צדי, חזית חיישני EO/IR משולבת ומעטפת קנה מאווררת. זוהי גאומטריית המחשה חיצונית בלבד; נתוני המסה, ניהול הרתע והכשירות האווירית כפופים לאימות הנדסי.",
    ...
    focusExternalInterfaceText: "שני בידוני דלק חיצוניים בעלי מעטפת טיפתית משולבים ישירות במתלים רציפים ונקיים שמתחת לכנפיים, ללא פיני תלייה חשופים או בלוקי חיבור שאינם שייכים; פרטי מערכת הדלק הפנימית אינם מוצגים.",

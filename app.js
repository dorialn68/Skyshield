...
const translations = {
  en: {
    ...
    focusFlightComputerText: "Reserved avionics volume beneath the flush aerodynamic upper fairing for flight-control and mission-compute integration; no crew cockpit is represented.",
    ...
    focusLandingGearText: "Two main legs deploy perpendicular to the low wing. Each has an external aerodynamic closure door, wheel-well throat, twin axle fork, machined rim, brake disc and tire; there is no nose wheel.",
  ...
  he: {
    ...
    focusFlightComputerText: "נפח אוויוניקה שמור מתחת לחיפוי העליון האווירודינמי והשטוח, לשילוב בקרת טיסה ומחשוב משימה; לא מוצג תא טייס.",
    ...
    focusLandingGearText: "שני כני הנסע יורדים בניצב לכנף הנמוכה. לכל מכלול דלת חיפוי אווירודינמית חיצונית הסוגרת את פתח כן הנסע בעת הקיפול, מזלג כפול, חישוק, דיסק בלם וצמיג; אין כן נסע קדמי.",

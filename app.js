...
const translations = {
  en: {
    ...
    hotspotRemoteWeapon: "Kinetic gimbal",
    ...
    focusRemoteWeaponTitle: "Kinetic gimbal assembly",
    focusRemoteWeaponText: "Detailed exterior demonstrator with a four-point vibration-isolated aircraft interface, azimuth drive, twin elevation yoke, serviceable receiver housing and compact barrel package. External presentation geometry only; mass properties, recoil management and airworthiness remain subject to engineering validation.",
  ...
  he: {
    ...
    hotspotRemoteWeapon: "מכלול קינטי מגומבל",
    ...
    focusRemoteWeaponTitle: "מכלול קינטי מגומבל",
    focusRemoteWeaponText: "מדגים חיצוני מפורט הכולל ממשק מטוס מבודד־רעידות בארבע נקודות, מנגנון צידוד, עריסת הגבהה דו־צדדית, בית מכלולים בר־תחזוקה ומעטפת קנה קומפקטית. זוהי גאומטריית המחשה חיצונית בלבד; נתוני המסה, ניהול הרתע והכשירות האווירית כפופים לאימות הנדסי.",

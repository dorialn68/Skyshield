...
const translations = {
  en: {
    ...
    focusRemoteWeaponText: "Presentation-only external geometry with a fastened yaw bearing, two-sided elevation trunnion, coated receiver, optic and forward barrel envelope.",
    focusEoirTitle: "EO / IR gimbal — Eagle Eye",
    focusEoirText: "Gyro-stabilized sensor presentation with a machined optical face plate, three recessed viewing channels, azimuth bearing and roll-axis trunnions.",
    ...
    heroCaption: "Parametric concept model · High-resolution PBR materials · Ximango-derived proportions",
  ...
  he: {
    ...
    focusRemoteWeaponText: "גאומטריה חיצונית להמחשה בלבד הכוללת מיסב אזימוט מעוגן, ציר הטיה דו־צדדי, בית מכלול מצופה, כוונת ומעטפת קנה קדמית.",
    focusEoirTitle: "גימבל EO / IR — Eagle Eye",
    focusEoirText: "המחשה של חיישן רב־מפתחים מיוצב, עם לוח חזית מעובד, שלושה ערוצי תצפית שקועים, מיסב אזימוט וצירי גלגול.",
    ...
    heroCaption: "מודל קונספט פרמטרי · חומרי PBR ברזולוציה גבוהה · פרופורציות המבוססות על Ximango",

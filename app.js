...
const translations = {
  en: {
    ...
    focusLandingGearText: "Two main legs deploy perpendicular to the low wing through wing-integrated trunnion housings. Each has an unequal-taper outboard composite cover: it masks the wheel structure externally while leaving a small tire contact section visible below and the wheel and fork readable from the inboard side; there is no nose wheel.",
  ...
  he: {
    ...
    focusLandingGearText: "שני כני הנסע יורדים בניצב לכנף הנמוכה דרך בתי ציר המשולבים במבנה הכנף. לכל מכלול חיפוי מרוכב חיצוני בעל דפנות משופעות שאינן סימטריות: הוא מסתיר את מבנה הגלגל מבחוץ, אך משאיר קטע קטן של הצמיג גלוי מתחתיו ואת הגלגל והמזלג נראים מן הצד הפנימי; אין כן נסע קדמי.",
